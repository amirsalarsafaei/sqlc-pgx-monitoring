...
// Observe provides a mock function for the type MockFloat64Observer
func (_mock *MockFloat64Observer) Observe(value float64, options ...metric.ObserveOption) {
...
func (_c *MockFloat64Observer_Observe_Call) RunAndReturn(run func(value float64, options ...metric.ObserveOption)) *MockFloat64Observer_Observe_Call {
	_c.Run(run)
	return _c
}

// float64Observer provides a mock function for the type MockFloat64Observer
func (_mock *MockFloat64Observer) float64Observer() {
	_mock.Called()
	return
}
